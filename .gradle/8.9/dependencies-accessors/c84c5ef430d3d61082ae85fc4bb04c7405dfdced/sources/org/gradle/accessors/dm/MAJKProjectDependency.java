...
@NonNullApi
public class MAJKProjectDependency extends DelegatingProjectDependency {

    @Inject
    public MAJKProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
